...
#STARMAPs
res1 <- starmaps(counts.ra, meta.ra, "disease", counts.sc, meta.sc, "disease", sbst1 = c("Control", "RA"))
...
#STARMAPs
res2 <- starmaps(counts1, meta1, "disease", counts2, meta2, "Fractalkine", sbst1 = c("Control", "RA"))
